...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i9.GetCategoryListByParamsUseCase>(() =>
      _i9.GetCategoryListByParamsUseCase(
          repository: gh<_i6.MessageRepository>()));
  gh.lazySingleton<_i10.GetCategoryListUseCase>(() =>
      _i10.GetCategoryListUseCase(repository: gh<_i6.MessageRepository>()));
  gh.lazySingleton<_i11.GetMessagesListUseCase>(() =>
      _i11.GetMessagesListUseCase(repository: gh<_i6.MessageRepository>()));
  gh.factory<_i12.MessagesBloc>(() => _i12.MessagesBloc(
        getMessagesListUseCase: gh<_i11.GetMessagesListUseCase>(),
        sendMessageUseCase: gh<_i8.SendMessageUseCase>(),
      ));
  gh.factory<_i13.CategoryBloc>(() => _i13.CategoryBloc(
        getCategoryListUseCase: gh<_i10.GetCategoryListUseCase>(),
        getCategoryListByParamsUseCase:
            gh<_i9.GetCategoryListByParamsUseCase>(),
      ));
  return get;
}
